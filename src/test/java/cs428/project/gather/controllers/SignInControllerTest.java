...
public class SignInControllerTest extends ControllerTest {
	...
	public void testSignInUserWrongPassword() throws JsonProcessingException {
		ResponseEntity<RESTResponseData> apiResponse = authenticateUser("existed@email.com", "wrongpassword");
		RESTResponseData responseData = apiResponse.getBody();
	...
	public void testSignInInvalidEmail() throws JsonProcessingException {
		ResponseEntity<RESTResponseData> apiResponse = authenticateUser(".Thi$IsN0TaEM@il", "password");
		RESTResponseData responseData = apiResponse.getBody();
	...
	public void testSignInInvalidPassword() throws JsonProcessingException {
		ResponseEntity<RESTResponseData> apiResponse = authenticateUser("existed@email.com", "ThisPasswordIsTooLongAndItShouldNotBeAnValidPasswordSoTheTestShouldFail");
		RESTResponseData responseData = apiResponse.getBody();
	...
	public void testSignInUserNotExist() throws JsonProcessingException {
		ResponseEntity<RESTResponseData> apiResponse = authenticateUser("notexisted@email.com", "password");
		RESTResponseData responseData = apiResponse.getBody();
