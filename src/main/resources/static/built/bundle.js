...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_React$Component) {
		...
		_createClass(App, [{
			...
			value: function componentDidMount() {
				...
				client({ method: 'GET', path: '/api/registereds' }).done(function (response) {
					_this.setState({ registereds: response.entity._embedded.registereds });
				});
			}
		}, {
			key: 'render',
			value: function render() {
				return React.createElement(RegisteredList, { registereds: this.state.registereds });
			}
		}]);
	...
	var RegisteredList = (function (_React$Component2) {
		_inherits(RegisteredList, _React$Component2);
	
		function RegisteredList() {
			_classCallCheck(this, RegisteredList);
	
			_get(Object.getPrototypeOf(RegisteredList.prototype), 'constructor', this).apply(this, arguments);
		}
	
		_createClass(RegisteredList, [{
			key: 'render',
			value: function render() {
				var registereds = this.props.registereds.map(function (registered) {
					return React.createElement(Registered, { key: registered._links.self.href, registered: registered });
				});
	...
	var Registered = (function (_React$Component3) {
		_inherits(Registered, _React$Component3);
	
		function Registered() {
			_classCallCheck(this, Registered);
	
			_get(Object.getPrototypeOf(Registered.prototype), 'constructor', this).apply(this, arguments);
		}
			...
			value: function render() {
				return React.createElement(
					...
					React.createElement(
						'td',
						null,
						this.props.registered.firstName
					),
					React.createElement(
						'td',
						null,
						this.props.registered.lastName
					),
					React.createElement(
						'td',
						null,
						this.props.registered.age
					)
				);
			}
		}]);
