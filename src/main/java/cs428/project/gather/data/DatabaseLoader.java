...
public class DatabaseLoader implements CommandLineRunner {
	...
	public void run(String... strings) throws Exception {
		...
		Registrant User2 = new Registrant("kutchathena@beier-mitchell.com","password","luciogoyette",2,6,92013);
		this.registrantRepo.save(User2);
		Registrant User3 = new Registrant("ellianahilll@ruecker-mayert.com","password","qdonnelly",9,16,92164);
		this.registrantRepo.save(User3);
		Registrant User4 = new Registrant("zturner@gmail.com","password","osborn69",4,21,92176);
		this.registrantRepo.save(User4);
		Registrant User5 = new Registrant("paucekchad@hand.com","password","staffordwelch",4,13,92137);
		this.registrantRepo.save(User5);
		Registrant User6 = new Registrant("utorp@hotmail.com","password","wunschruel",8,5,92153);
		this.registrantRepo.save(User6);
		Registrant User7 = new Registrant("vernhamill@marquardt.com","password","adelia56",6,11,92065);
		this.registrantRepo.save(User7);
		Registrant User8 = new Registrant("stephancarter@gmail.com","password","lmcglynn",10,13,91950);
		this.registrantRepo.save(User8);
		Registrant User9 = new Registrant("beecher87@yahoo.com","password","katie22",1,2,92013);
		this.registrantRepo.save(User9);
		Registrant User10 = new Registrant("clueilwitz@hotmail.com","password","feiltrae",4,17,92069);
		this.registrantRepo.save(User10);
		Registrant User11 = new Registrant("vhaley@boyle.info","password","bfunk",6,17,92196);
		this.registrantRepo.save(User11);
		Registrant User12 = new Registrant("nicklaus61@howe.biz","password","jaxkohler",4,17,92108);
		this.registrantRepo.save(User12);
		Registrant User13 = new Registrant("garrisonmraz@schneider.com","password","qcummerata",2,2,92114);
		this.registrantRepo.save(User13);
		Registrant User14 = new Registrant("kbatz@yahoo.com","password","langworthspencer",9,7,92088);
		this.registrantRepo.save(User14);
		Registrant User15 = new Registrant("asipes@cormier.info","password","brinleypollich",10,18,92127);
		this.registrantRepo.save(User15);
		Registrant User16 = new Registrant("wymanbechtelar@yahoo.com","password","eulabarton",2,7,92128);
		this.registrantRepo.save(User16);
		Registrant User17 = new Registrant("almiracorwin@hotmail.com","password","leeroywisozk",7,17,92175);
		this.registrantRepo.save(User17);
		Registrant User18 = new Registrant("mlakin@spencer-howell.com","password","daniellyric",9,21,91901);
		this.registrantRepo.save(User18);
		Registrant User19 = new Registrant("trena64@gmail.com","password","botsfordalexandr",2,13,92134);
		this.registrantRepo.save(User19);
		Registrant User20 = new Registrant("inicolas@strosin-hills.info","password","metzansley",9,9,92007);
		this.registrantRepo.save(User20);
		Registrant User21 = new Registrant("kosskatarina@yahoo.com","password","lynseyaufderhar",4,9,92039);
		this.registrantRepo.save(User21);
		Registrant User22 = new Registrant("carmelita93@yahoo.com","password","starr10",8,7,92182);
		this.registrantRepo.save(User22);
		Registrant User23 = new Registrant("muellerlillard@hyatt-schaefer.com","password","kwisozk",5,6,91980);
		this.registrantRepo.save(User23);
		Registrant User24 = new Registrant("pfannerstillmallie@konopelski-ziemann.org","password","jay30",2,13,92116);
		this.registrantRepo.save(User24);
		Registrant User25 = new Registrant("yaretzifarrell@hotmail.com","password","twisoky",9,9,92019);
		this.registrantRepo.save(User25);
		Registrant User26 = new Registrant("ethiestanton@friesen.com","password","wolfraymond",1,21,92123);
		this.registrantRepo.save(User26);
		Registrant User27 = new Registrant("greenemett@shanahan.info","password","jermeygulgowski",4,19,92140);
		this.registrantRepo.save(User27);
		Registrant User28 = new Registrant("ullrichhence@hotmail.com","password","zanderson",3,17,91946);
		this.registrantRepo.save(User28);
		Registrant User29 = new Registrant("farah45@gulgowski-runolfsdottir.org","password","roccocremin",7,1,92085);
		this.registrantRepo.save(User29);
		Registrant User30 = new Registrant("hermistonhurbert@hayes-heller.com","password","stoltenbergaleen",6,11,92190);
		this.registrantRepo.save(User30);
		Registrant User31 = new Registrant("brennanratke@gmail.com","password","sheritakuphal",8,21,92010);
		this.registrantRepo.save(User31);
		Registrant User32 = new Registrant("bridgermiller@wehner.com","password","hrodriguez",5,10,92199);
		this.registrantRepo.save(User32);
		Registrant User33 = new Registrant("edouglas@hand-hintz.net","password","georgiana46",8,3,91933);
		this.registrantRepo.save(User33);
		Registrant User34 = new Registrant("cathleen48@yahoo.com","password","mschowalter",10,2,92010);
		this.registrantRepo.save(User34);
		Registrant User35 = new Registrant("astroman@williamson-borer.com","password","cnader",4,23,91903);
		this.registrantRepo.save(User35);
		Registrant User36 = new Registrant("hamilljethro@hotmail.com","password","shirliestrosin",1,13,92163);
		this.registrantRepo.save(User36);
		Registrant User37 = new Registrant("dhalvorson@hotmail.com","password","gulgowskitheadore",9,23,92010);
		this.registrantRepo.save(User37);
		Registrant User38 = new Registrant("hellerkimball@hahn.net","password","loveyheaney",7,2,92105);
		this.registrantRepo.save(User38);
		Registrant User39 = new Registrant("torn@grimes.biz","password","jeseniaschuppe",2,3,92142);
		this.registrantRepo.save(User39);
		Registrant User40 = new Registrant("brennenbrakus@strosin.biz","password","strosinqueen",3,10,91909);
		this.registrantRepo.save(User40);
		Registrant User41 = new Registrant("powlowskiwillodean@gleason.info","password","rosco73",6,9,92165);
		this.registrantRepo.save(User41);
		Registrant User42 = new Registrant("krismaxim@yahoo.com","password","hazle26",6,3,92070);
		this.registrantRepo.save(User42);
		Registrant User43 = new Registrant("jewellbaumbach@huel-funk.org","password","farmstrong",9,3,92025);
		this.registrantRepo.save(User43);
		Registrant User44 = new Registrant("hayeschristi@wilderman.com","password","zchristiansen",2,10,92033);
		this.registrantRepo.save(User44);
		Registrant User45 = new Registrant("gearldine69@kutch-morissette.com","password","townewillian",2,6,92126);
		this.registrantRepo.save(User45);
		Registrant User46 = new Registrant("bednarconrad@vonrueden.org","password","carolannhegmann",8,7,92021);
		this.registrantRepo.save(User46);
		Registrant User47 = new Registrant("charley28@heathcote-leffler.org","password","katlin75",5,15,92033);
		this.registrantRepo.save(User47);
		Registrant User48 = new Registrant("icaschinner@price.com","password","ibatz",1,8,92136);
		this.registrantRepo.save(User48);
		Registrant User49 = new Registrant("lucretia52@osinski-hirthe.com","password","adela14",2,18,92060);
