...
public class GlobalCoordinates implements Comparable<GlobalCoordinates>, Serializable {
	...
	/**
	 * Compare these coordinates to another set of coordinates. Western
	 * longitudes are less than eastern longitudes. If longitudes are equal, then
